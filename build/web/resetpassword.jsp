<%-- 
    ...
    Created on : Sep 19, 2023, 3:01:45 AM
    Author     : hayha
--%>
            ...
            <form method="post" action="resetpassword">
                ...
                <div class="login-form">
                    ...
                    <div class="form-input">
                        ...
                        <input id="new_password" type="password" name="password" placeholder="Enter your new password" required onchange="checkRePassword()">
                        <label for="confirm-password">Re enter your new password:</label>
                        <input id="re_passsword" type="password" name="repassword" placeholder="Confirm your new password" required onchange="checkRePassword()">
