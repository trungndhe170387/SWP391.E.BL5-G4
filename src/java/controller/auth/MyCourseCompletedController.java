 ...
 * @author Admin
 */
@WebServlet(name = "MyCourseCompletedController", urlPatterns = {"/mycoursecompleted"})
public class MyCourseCompletedController extends BaseRequiredAuthorizationController {
    ...
    protected void doAuthGet(HttpServletRequest request, HttpServletResponse response, Account acc) throws ServletException, IOException {
        ...
        List<Learner_Subject> listLS = sdao.getAllMyCourseCompleted(learner_id);
...
//        response.getWriter().write(jsonobj.toString());
        request.getRequestDispatcher("mycoursecompleted.jsp").forward(request, response);
    }
